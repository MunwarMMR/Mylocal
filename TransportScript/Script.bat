...
RD /S /Q "C:\Users\admin\Desktop\Folders\Transportnew"

cd "C:\Users\admin\Desktop\Folders"

git clone -b develop https://munwar24:mujeeb24@github.com/MunwarMMR/android-local-tcflow-transport.git Transportnew
